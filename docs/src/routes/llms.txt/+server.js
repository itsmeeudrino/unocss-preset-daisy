// Port of packages/docs/src/routes/llms.txt/+server.js
// (upstream ref: saadeghi/daisyui@master).
//
// Fork delta: same as `SKILL.md/+server.js` — `skills/` glob adjusted from
// 5 to 4 levels for this fork's flatter layout. Runtime frontmatter
// transform (`source:`/`alwaysApply`/`applyTo:`) kept verbatim.
