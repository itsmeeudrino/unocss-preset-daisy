...
export const languageMetadata = {
  ...
  el: { __name: "Ελληνικά", __code: "EL", __direction: "ltr" },
  ...
  he: { __name: "עברית", __code: "HE", __direction: "rtl" },
  ...
  tr: { __name: "Türkçe", __code: "TR", __direction: "ltr" },
  uk: { __name: "Українська", __code: "UK", __direction: "ltr" },
  ur: { __name: "اردو", __code: "UR", __direction: "rtl" },
